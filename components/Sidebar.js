...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Header: Logo & Tombol Hamburger di KANAN ATAS Sidebar */}
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          {isOpen ? (
            <span className="text-xl font-semibold text-gray-800">Calgot</span>
          ) : (
      ...
      {/* Overlay di mobile (hanya muncul saat sidebar terbuka) */}
      {isOpen && (
        <div
